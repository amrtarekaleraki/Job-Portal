...
@section('seo_meta_description') {{ $other_page_item->forget_password__meta_description }} @endsection --}}
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                        <div class="login-form">
                            <form action="{{ route('candidate_forget_passsword_submit') }}" method="post">
                                @csrf
