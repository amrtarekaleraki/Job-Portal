...
class CandidateController extends Controller
{
    ...
    {
        $total_applied_jobs =  CandidateApply::where('candidate_id',Auth::guard('candidate')->user()->id)->where('status','Applied')->count();

        $total_rejected_jobs =  CandidateApply::where('candidate_id',Auth::guard('candidate')->user()->id)->where('status','Rejected')->count();

        $total_approved_jobs =  CandidateApply::where('candidate_id',Auth::guard('candidate')->user()->id)->where('status','Approved')->count();
    ...
    public function edit_profile_update(Request $request)
    {
        ...
        if($request->hasFile('photo'))
        {
            ...
            $final_name = 'candidate_photo'.time().'.'.$ext;
    ...
    public function education_update(Request $request ,$id)
    {
       ...
       return redirect()->route('candidate_education')->with('success','education updated successfully');
    }
    ...
    public function education_delete($id)
    {
       ...
       return redirect()->route('candidate_education')->with('success','education deleted successfully');
    }
    ...
    public function skill_update(Request $request ,$id)
    {
       ...
       return redirect()->route('candidate_skill')->with('success','skill updated successfully');
    }
    ...
    public function skill_delete($id)
    {
       ...
       return redirect()->route('candidate_skill')->with('success','skill deleted successfully');
    }
    ...
    public function experience_update(Request $request ,$id)
    {
       ...
       return redirect()->route('candidate_experience')->with('success','experience updated successfully');
    }
    ...
    public function experience_delete($id)
    {
       ...
       return redirect()->route('candidate_experience')->with('success','experience deleted successfully');
    }
    ...
    public function award_update(Request $request ,$id)
    {
       ...
       return redirect()->route('candidate_award')->with('success','award updated successfully');
    }
    ...
    public function award_delete($id)
    {
       ...
       return redirect()->route('candidate_award')->with('success','award deleted successfully');
    }
    ...
    public function resume_update(Request $request ,$id)
    {
       ...
       return redirect()->route('candidate_resume')->with('success','resume updated successfully');
    }
    ...
    public function resume_delete($id)
    {
       ...
       return redirect()->route('candidate_resume')->with('success','resume deleted successfully');
    }
    ...
    public function bookmark_add($id)
    {
        ...
        return redirect()->back()->with('success','Job is added to Bookmark successfully');
    }


    public function bookmark_view()
    {
        $bookmarked_jobs = CandidateBookmark::with('rCandidate','rJob')->where('candidate_id',Auth::guard('candidate')->user()->id)->get();
    ...
    {
        $existing_apply_check =  CandidateApply::where('candidate_id',Auth::guard('candidate')->user()->id)->where('job_id',$id)->count();
    ...
    {
        $applied_jobs =  CandidateApply::with('rJob')->where('candidate_id',Auth::guard('candidate')->user()->id)->get();
