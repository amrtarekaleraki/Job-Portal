...
class AdminBannerController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        {
            $request->validate([
                'banner_job_listing' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_job_detail' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_job_categories' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_company_listing' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_company_detail' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_pricing' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_blog' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_post' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_faq' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_contact' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_terms' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_privacy' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_signup' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_login' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_forget_password' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_company_panel' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'banner_candidate_panel' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        return redirect()->back()->with('success','Banners is Updated successfully');
