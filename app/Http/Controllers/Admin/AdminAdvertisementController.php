...
class AdminAdvertisementController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        {
            $request->validate([
                'job_listing_ad' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        {
            $request->validate([
                'company_listing_ad' => 'image|mimes:png,jpg,jpeg,gif'
            ]);
        ...
        return redirect()->back()->with('success','Ads is Updated successfully');
