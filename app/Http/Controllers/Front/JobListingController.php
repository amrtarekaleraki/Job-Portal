...
class JobListingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('front.job_listing',compact('jobs','job_categories','job_locations','job_types',
        'job_experiences','job_genders','job_salary_ranges','form_title','form_category','form_location',
        'form_type','form_experience','form_gender','form_salary_range','advertisement_data','other_page_item'));
    ...
    public function detail($id)
    {
        ...
        $job_single = Job::with('rCompany','rJobCategory','rJobLocation','rJobSalaryRange','rJobType','rJobExperience','rJobGender')->where('id',$id)->first();

        $jobs = Job::with('rCompany','rJobCategory','rJobLocation','rJobSalaryRange','rJobType','rJobExperience','rJobGender')->where('job_category_id',$job_single->job_category_id)->get();
