...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // $featured_jobs = Job::with('rCompany','rJobCategory','rJobLocation','rJobSalaryRange','rJobType','rJobExperience','rJobGender')->orderBy('id','desc')->where('is_featured',1)->take(6)->get();
        $featured_jobs = Job::with('rCompany','rJobCategory','rJobLocation','rJobSalaryRange','rJobType','rJobExperience','rJobGender')->orderBy('id','desc')->where('is_featured',1)->get();
