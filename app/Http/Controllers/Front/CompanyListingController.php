...
class CompanyListingController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        if(CompanyPhoto::where('company_id',$company_single->id))
        {
        ...
        if(CompanyVideo::where('company_id',$company_single->id))
        {
        ...
        $jobs = Job::with('rJobCategory','rJobLocation','rJobSalaryRange','rJobType','rJobExperience','rJobGender')->where('company_id',$company_single->id)->get();
