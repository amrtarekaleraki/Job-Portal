...
class ForgetPasswordController extends Controller
{
    ...
    public function company_forget_passsword_submit(Request $request)
    {
         $request->validate([
    ...
    public function company_reset_password_submit(Request $request)
    {
        ...
        return redirect()->route('login')->with('success','Password is reset successfully you can login to system now.');
    }
    ...
    public function candidate_forget_passsword_submit(Request $request)
    {
         $request->validate([
             'email' => 'required|email',
         ]);
